    ...
    function initializeBreedCards(breedData) {
        ...
        breedCards.forEach(card => {
            ...
            card.addEventListener('click', () => {
                ...
                document.getElementById('modalCharacteristics').textContent = breedInfo.characteristics;
                document.getElementById('modalTemperament').textContent = breedInfo.temperament;
                document.getElementById('modalCare').textContent = breedInfo.care;
                document.getElementById('modalHealth').textContent = breedInfo.health;
